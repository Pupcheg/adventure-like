...
public class BuildableAdventureLikeGenerationStrategy implements AdventureLikeGenerationStrategy {
    ...
    public TypeSpec generate(@NotNull Element element) {
        ...
        ClassName targetName = ClassName.get(packageElement.getQualifiedName().toString(), element.getSimpleName() + "Impl");
        ...
        new BuilderImplGenerationStep(annotationHelper, targetName, element, parameters).generate(target);
